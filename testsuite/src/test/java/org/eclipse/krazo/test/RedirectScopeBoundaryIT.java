...
public class RedirectScopeBoundaryIT {

    private static final String WEB_INF_SRC = "src/main/resources/redirectboundary/";
    ...
    @Deployment(testable = false, name = "redirectboundary")
    public static Archive createDeployment() {
        return new WebArchiveBuilder()
            .addPackage("org.eclipse.krazo.test.redirectboundary")
    ...
    public void redirectFromAToADisplaysMessage() throws Exception {
        final HtmlPage page = webClient.getPage(baseURL + "resources/a");
