 ...
 */
public class KrazoConfigImpl implements KrazoConfig {

    @Inject
    @JaxRsContext
    private Configuration config;

    @Override public Csrf.CsrfOptions getCsrfOptions() {
    ...
    @Override public CsrfTokenStrategy getCsrfTokenStrategy() {
    ...
    @Override public String getDefaultViewFileExtension() {
    ...
    @Override public String getCsrfHeaderName() {
    ...
    @Override public String getRedirectScopeCookieName() {
    ...
    @Override public String getRedirectScopeAttributeName() {
        Object value = config.getProperty(Properties.REDIRECT_SCOPE_ATTRIBUTE_NAME);
        if (value instanceof String) {
            return (String) value;
        }
        return RedirectScopeManager.DEFAULT_ATTR_NAME;
    }
