...
Coming with version 2.6.1., Thorntail provides a stable fraction for MVC with Krazo. In the meantime, you can use the JAX-RS fraction and add
...
*Note:* The existing, experimental fraction is still based on a 2 year old version Ozark, the predecessor of Krazo. Please don't use it, as you won't
get the features Krazo provides in the meantime.
